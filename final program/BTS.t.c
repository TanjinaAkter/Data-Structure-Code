...
struct node* newNode(int data)           /* Helper function that allocates a new node with the
...
void printPostorder(struct node* node) /* Given a binary tree, print its nodes according to the
                                       "bottom-up" postorder traversal. */
{
     ...
     printPostorder(node->right);     // first recur on right subtree
